...
class TestBreakpoints < Test::Unit::TestCase
  def test_find
    ...
    assert_not_nil(Debugger::Breakpoint.find(Debugger.unreachable_breakpoints['foo.rb'], 'foo.rb', 11, nil))
  ...
  def test_conditional_false_expression
    ...
    assert_nil(Debugger::Breakpoint.find(Debugger.breakpoints, "foo.rb", 11, nil))
    assert_nil(Debugger::Breakpoint.find(Debugger.unreachable_breakpoints['foo.rb'], 'foo.rb', 11, nil))
    Debugger.stop
  end
